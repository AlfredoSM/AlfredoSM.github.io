...
Robot.prototype.operations.rotateCCW = function(robot, angle){
 ...
 function setup(){
  ...
  mapa[4]="xx r       r       xxxxx";
  mapa[5]="xxrxxrxxxxxxxxxxxxxxxxxx";
  mapa[6]="xx x         r     xxxxx";
  mapa[7]="xx    r         xxxxxxxx";
  mapa[8]="xxxxxxxxxx   r   r xxxxx";
  mapa[9]="xx            r     xxxx";
  mapa[10]="xxxxx r xxxxxxxx xxxxxxx";
  mapa[11]="xxxxxx rxxxxxxxx xxxxxxx";
  mapa[12]="xxxxxxx rxxxxxxx xxxxxxx";
  mapa[13]="xxxxxxxx r rxxxx xxxxxxx";
  mapa[14]="xxxxxxxxxx r xxx xxxxxxx";
  mapa[15]="xxxxxxxxxxxxr xx xxxxxxx";
